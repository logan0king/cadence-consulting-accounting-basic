    ...
    return {
      ...
      data: {
        ...
        datasets: [{
          ...
          borderColor: '#fff',
          borderWidth: this.properties?.pie?.borderWidth || 2
        }]
      },
      options: {
        responsive: true,
        ...
        plugins: {
          legend: {
            display: this.properties?.pie?.showLegend !== false,
            position: this.properties?.pie?.legendPosition || 'right'
          },
          title: {
            display: true,
            text: this.properties.title || 'Pie Chart'
          },
          tooltip: {
            callbacks: {
              label: (context) => {
